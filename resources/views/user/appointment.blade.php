<div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Umów swoją wizytę u lekarza</h1>

      <form class="main-form" action="{{url('appointment')}}" method="POST">
        @csrf
        <div class="row mt-5 ">
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft">
            <input type="text" name="name" class="form-control" placeholder="Dane">
          </div>
        ...
        <button type="submit" class="btn btn-primary" style="background-color:#00D9A5">Umów wizytę</button>
      </form>
    </div>
  </div>