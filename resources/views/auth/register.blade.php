<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="name" value="Nazwa" />
            ...
            <div class="mt-4">
                <x-jet-label for="password_confirmation" value="Potwierdź hasło" />
